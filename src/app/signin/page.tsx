...
export default function SignInPage() {
    ...
    return (
        <div style={{
            ...
            <div style={{ position: 'absolute', top: '10%', left: '10%', width: '300px', height: '300px', background: 'rgba(94, 197, 207, 0.15)', borderRadius: '50%', filter: 'blur(80px)', zIndex: 0 }}></div>
            <div style={{ position: 'absolute', bottom: '10%', right: '10%', width: '300px', height: '300px', background: 'rgba(59, 130, 246, 0.1)', borderRadius: '50%', filter: 'blur(80px)', zIndex: 0 }}></div>
            ...
            >
                ...
                <div style={{
                    ...
                    <form onSubmit={handleSignIn} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                        ...
                        <div>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                <input
                                    type="email"
                                    placeholder="agent@collings.com.au"
                                    defaultValue="james@collings.com.au"
                                    style={{
                                        width: '100%',
                                    ...
                                    onFocus={(e) => { e.target.style.borderColor = '#5ec5cf'; e.target.style.background = 'white'; box - shadow: '0 0 0 4px rgba(94, 197, 207, 0.1)'; }}
                        ...
                        <div>
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                                <label style={{ fontWeight: '700', color: '#334155', fontSize: '0.875rem' }}>Password</label>
                                <a href="#" style={{ color: '#5ec5cf', fontSize: '0.875rem', fontWeight: '600', textDecoration: 'none' }}>Forgot password?</a>
                            </div>
                            <div style={{ position: 'relative' }}>
                    ...
                    <div style={{ marginTop: '2rem', textAlign: 'center', paddingTop: '1.5rem', borderTop: '1px solid #f1f5f9', color: '#64748b', fontSize: '0.9rem' }}>
                        Don't have an account? <Link href="/signup" style={{ color: '#5ec5cf', fontWeight: '700', textDecoration: 'none' }}>Create free account</Link>
                    </div>
